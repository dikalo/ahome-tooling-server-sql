...
package com.ait.tooling.server.sql.test
...
class BasicTestsSpecification extends ServerCoreSpecification implements CoreGroovyTrait
{
    def setupSpec()
    {        
        TestingOps.setupServerCoreDefault(["classpath:/com/ait/tooling/server/sql/test/ApplicationContext.xml", "classpath:/com/ait/tooling/server/core/config/CoreApplicationContext.xml"])
    }
